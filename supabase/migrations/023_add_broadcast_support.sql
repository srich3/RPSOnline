-- Migration: Add broadcast support for real-time game updates
-- This enables real-time notifications when games are created, updated, or deleted
...
-- This will broadcast match events to both players when games are created, updated, or deleted
