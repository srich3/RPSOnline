-- Fix the game cancellation broadcast trigger to use realtime.broadcast_changes
-- This ensures the frontend receives the cancellation notifications properly
