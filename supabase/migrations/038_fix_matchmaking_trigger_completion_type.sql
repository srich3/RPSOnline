-- Fix the process_matchmaking function to remove completion_type references
-- Update the function to use the new status-based logic instead of completion_type
...
-- Also fix the cleanup function to remove completion_type references
