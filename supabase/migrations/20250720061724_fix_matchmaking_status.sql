-- Fix matchmaking to create games with 'waiting' status instead of 'active'
-- This ensures the frontend can properly detect matches

-- Update the matchmaking function to create waiting games when both players are found
